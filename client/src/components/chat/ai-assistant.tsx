          ...
          <div className="p-4 border-t border-border">
            <div className="flex space-x-2">
              ...
              <Button
                ...
                size="sm"
                className="group px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white shadow-md hover:shadow-lg transition-all duration-200 disabled:cursor-not-allowed"
